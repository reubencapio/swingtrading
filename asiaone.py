...
class someSpider(CrawlSpider):
	name = 'asiaone'
	allowed_domains = ['news.asiaone.com']
	start_urls = ['http://news.asiaone.com/news/business']
	
	rules = (Rule (LinkExtractor(allow=r'news/business/'), callback="parse_obj", follow=True),)
