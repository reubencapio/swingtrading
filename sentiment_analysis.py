...
if __name__ == "__main__":
	...
	#reuben
	directory = "C:/news_data_for_nlp/"
	for filename in os.listdir(directory):
		print("filename: ", filename)
		if filename.endswith(".txt"): 
			#testfile = "C:/Users/user/Desktop/nlp_proj/review_test.txt"
			testfile = directory + filename
			print("testfile: ", testfile)
			pfile = open(testfile, encoding="utf8")
			text = pfile.read()
			...
			#pprint(splitted_sentences) #reuben

			pos_tagged_sentences = postagger.pos_tag(splitted_sentences)
			#pprint(pos_tagged_sentences) #reuben

			dict_tagged_sentences = dicttagger.tag(pos_tagged_sentences)
			#pprint(dict_tagged_sentences) #reuben
